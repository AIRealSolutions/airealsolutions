...
export default async function FactoryPage(){
  ...
  return <main>
    <header className="site-header"><a className="brand" href="/"><span className="brand-mark">AI</span><span>Real Solutions</span></a><nav><a href="/services">Services</a><a href="/products">Products</a><a href="/about">About</a><a href="/login">My Factory</a><a className="nav-cta" href="/build">Start a Build</a></nav></header>
