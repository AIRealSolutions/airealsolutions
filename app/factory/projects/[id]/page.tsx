...
const tabs=["Overview","Assembly Line","Build Brief","Architecture","Economics","Features","Automations","Data","Integrations","Prototype","Activity"];
...
export default async function ProjectWorkspace({params}:{params:Promise<{id:string}>}){
  ...
  return <main>
    ...
    <section className="section factory-workspace">
      <div className={styles.tabs}>{tabs.map((t,i)=><a href={t==="Assembly Line"?"#assembly-line":t==="Architecture"?"#architecture":t==="Economics"?"#economics":"#overview"} key={t} className={i===0?styles.active:""}>{t}</a>)}</div>
